...
import { createUser,loggedInUser, logoutUser, createPost,updateProfile,searchUsers,likePost} from "../controllers/user.controller.js";
...
app.get("/like/:postid",isLoggedIn,likePost)
